...
<div class="content">
    <form action="/mannschaft/doUpdate?id=<?= $m_id ?>" method="post">
        ...
        <input id="mannschaftsname" name="mannschaftsname" type="text" value="<?=($mannschaft->mannschaftsname); ?>" class="textForm" required/>

        <label for="coach" class="label">Coach</label>
        <input id="coach" name="coach" type="text"  value="<?=($mannschaft->coach); ?>" class="textForm" required/>
